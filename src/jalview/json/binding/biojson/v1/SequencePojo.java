...
public class SequencePojo
{
  ...
  @Attributes(
    required = true,
    description = "The index of the sequenceâ€™s first residue in its source database, <br>using a one-based numbering index system")
  private int start;

  @Attributes(
    required = true,
    description = "The index of the sequenceâ€™s last residue in its source database, <br>using a one-based numbering index system")
  private int end;
